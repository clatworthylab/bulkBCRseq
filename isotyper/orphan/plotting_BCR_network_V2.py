...
def main(argv):
    ...
    att[3] = [
        str(cluster_id_dict[c]) if c in cluster_id_dict.keys() else None
        for c in att[0]
    ]

    att[4] = [
        str(cluster_sorted_dict[c]) if c in cluster_sorted_dict.keys() else None
        for c in att[0]
    ]
    ...
    tissue_col_dict = {
        ...
        "bladder": "#9467bd",
        "meninges": "#d62728",
        "mesenteric_lymph_nodes": "#79706e",
        "duodenum": "#1f77b4",
        "ilieum": "#1f77b4",
        "colon_proximal": "#1f77b4",
        "colon_distal": "#1f77b4",
    }
    clone_col_dict = {
        "A": "#4e79a7",
